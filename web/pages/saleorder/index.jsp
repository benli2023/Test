	...
	<div class="queryPanel">
		<fieldset>
			...
			<table>
				...
				<tr>	
					<td class="tdLabel"><%=SaleOrder.ALIAS_CREATOR%></td>		
					<td>
						<input value="${query.creator}" id="creator" name="creator" maxlength="64"  class=""/>
					</td>
		...
		<table width="100%"  border="0" cellspacing="0" class="gridBody">
		  <thead>
			  ...
			  <tr>
				...
				<th sortColumn="creator" ><%=SaleOrder.ALIAS_CREATOR%></th>
