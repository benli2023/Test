...
<link rel="stylesheet" href="${ctx}/theme/katniss/css/style.default.css" type="text/css" />
<script type="text/javascript" src="${ctx}/theme/katniss/js/jquery-1.8.3.min.js"></script>
