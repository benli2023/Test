...
public class AppDataController extends BaseRestSpringController<AppData,java.lang.Long>{
	...
	public String show(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		AppData appData = (AppData)appDataManager.getById(id);
	...
	public String update(ModelMap model,@PathVariable java.lang.Long id,@Valid AppData appData,BindingResult errors,HttpServletRequest request,HttpServletResponse response) throws Exception {
		if(errors.hasErrors()) {
			return "/appdata/edit";
		}
		
		appDataManager.update(appData);
	...
	public String batchDelete(ModelMap model,@RequestParam("items") java.lang.Long[] items) {
		for(int i = 0; i < items.length; i++) {
			appDataManager.removeById(items[i]);
		}
		Flash.current().success(DELETE_SUCCESS);
		return LIST_ACTION;
	}
