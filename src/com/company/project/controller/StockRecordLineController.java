...
public class StockRecordLineController extends BaseRestSpringController<StockRecordLine,java.lang.Long>{
	...
	public String show(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		StockRecordLine stockRecordLine = (StockRecordLine)stockRecordLineManager.getById(id);
	...
	public String create(ModelMap model,@Valid StockRecordLine stockRecordLine,BindingResult errors,HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		stockRecordLineManager.save(stockRecordLine);
	...
	public String update(ModelMap model,@PathVariable java.lang.Long id,@Valid StockRecordLine stockRecordLine,BindingResult errors,HttpServletRequest request,HttpServletResponse response) throws Exception {
		if(errors.hasErrors()) {
			return "/stockrecordline/edit";
		}
		
		stockRecordLineManager.update(stockRecordLine);
	...
	public String delete(ModelMap model,@PathVariable java.lang.Long id) {
		stockRecordLineManager.removeById(id);
	...
	public String batchDelete(ModelMap model,@RequestParam("items") java.lang.Long[] items) {
		for(int i = 0; i < items.length; i++) {
			stockRecordLineManager.removeById(items[i]);
		}
		Flash.current().success(DELETE_SUCCESS);
		return LIST_ACTION;
	}
